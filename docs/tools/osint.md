...
**URL:** [inteltechniques.com/tools](https://inteltechniques.com/tools/)

Michael Bazzell's comprehensive OSINT toolkit and resources. The gold standard.
...
Visual map of OSINT tools by category.
...
Analyse suspicious URLs safely. See what a page does without visiting it.

### WhereGoes

**URL:** [wheregoes.com](https://wheregoes.com/)

Trace URL redirects. See where shortened URLs actually go.

### Down for Everyone

**URL:** [downforeveryoneorjustme.com](https://downforeveryoneorjustme.com/)

Check if a site is actually down or just blocked for you.
...
**URL:** [pdfexaminer.com](https://www.pdfexaminer.com/)

Analyse PDF files for metadata. See when documents were created, by whom.

### ExifTool

**URL:** [exiftool.org](https://exiftool.org/)
...
**URL:** [dorksearch.com](https://dorksearch.com/)

Web-based dork builder and search assistant.

### sitedorks

**URL:** [github.com/Zarcolio/sitedorks](https://github.com/Zarcolio/sitedorks)

Pre-built dorks for 600+ websites.
...
**URL:** [searx.space](https://searx.space/)

Privacy-respecting metasearch. Aggregates results from multiple engines.

### Brave Search

**URL:** [search.brave.com](https://search.brave.com/)

Independent index with good operator support.

### Yandex

**URL:** [yandex.com](https://yandex.com/)
...
800B+ archived pages. Essential for broken links.

### Archive.today

**URL:** [archive.today](https://archive.today/)

Alternative archive. Captures some content Wayback misses.
...
- Finding official documents that should be public
...
- Anything that could harm people who use drugs
