...
1. Get the landscape (broad search)
2. Focus on jurisdiction
3. Find specific documents
4. Filter by recency
...
- Apply **Peer-Centered** lens throughout

### Save What Works

- Bookmark effective searches
- Create Google Alerts for ongoing monitoring
- Build a personal dork library for your work
